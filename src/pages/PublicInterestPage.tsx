  ...
  <div className="px-6 lg:px-16 py-[var(--space-10)]">
    <article className="max-w-[900px] mx-auto space-y-8">
      ...
      <section className="space-y-4 text-[15px] leading-[1.8]" style={{ color: 'var(--text-secondary)' }}>
        ...
        <p>DDA produces independent analysis of public records on institutional decisions, resource allocation, policy design, and public costs. Doyle leads the analysis, and Carroll Goldman leads engagement and communications. Together, they compare what an institution reported with what its published data and records show.</p>
      </section>
