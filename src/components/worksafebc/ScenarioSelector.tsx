  ...
  <>
    ...
    <article className="card space-y-4">
      ...
      <div className="grid md:grid-cols-2 gap-3 text-sm text-[#4a453d]">
        <p>
          <span className="text-[#9A6A28]">Trigger:</span> {scenario.trigger}
        </p>
        <p>
          <span className="text-[#9A6A28]">Timeline:</span> {scenario.timeline}
        </p>
        <p>
          <span className="text-[#9A6A28]">Annual increase:</span> {scenario.annualIncrease}
        </p>
        <p>
          <span className="text-[#9A6A28]">Total shock:</span> {scenario.totalShock}
        </p>
        <p>
          <span className="text-[#9A6A28]">Likelihood:</span> {scenario.likelihood}
        </p>
        <p>
          <span className="text-[#9A6A28]">Funded ratio progression:</span>{' '}
          {scenario.fundedProgression}
        </p>
      </div>
