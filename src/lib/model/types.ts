...
export interface Project { id: string; name: string; type: string; capacityMtpa?: number; inServiceYear: number; projectLifeYears: number; extendedLifeYears: number; modelStatus: string; }
