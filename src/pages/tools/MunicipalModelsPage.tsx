          ...
          <TabsContent value="population" className="space-y-4">
            ...
            <div className="grid gap-4 lg:grid-cols-2">
              <article className="rounded-xl border border-[#d8cdb9] bg-white p-4">
                ...
                <p className="rounded-md border border-[#efe4d1] bg-[#faf7f2] p-3 text-sm text-[#5e574a]">
                  Age structure projection requires custom cohort data not available in public sources.
                </p>
              </article>
